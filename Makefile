...
arkanoid.bin: $(BUILD_DIR)/ $(BUILD_DIR)/main.o $(BUILD_DIR)/dlib.lib $(BUILD_DIR)/sbc.lib
	ld65 -C durango16k.cfg $(BUILD_DIR)/main.o $(BUILD_DIR)/dlib.lib $(BUILD_DIR)/sbc.lib -o arkanoid.bin	
